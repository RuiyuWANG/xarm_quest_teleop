...
#   python src/scripts/run_policy_eval.py _config:=cleanup_table_d2_rollout.yaml
...
from src.io.camera import TwoRgbSync
...
def _apply_checkpoint_policy_contract(cfg: EvalConfig, net: SeekerPolicy) -> None:
