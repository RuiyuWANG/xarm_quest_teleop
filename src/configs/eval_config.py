...
from src.configs.collector_config import CameraSyncConfig, RobotSyncConfig, AutoLaunchConfig


@dataclass
class EvalConfig:
    # ---------------- model ----------------
    model_ckpt_path: str = "/root/catkin_ws/src/real_ws/seeker-dev/experiments/cleanup_table_d2/real_policy/real_rvt2_cleanup_table_d2_seed_0/checkpoints/latest.ckpt"
