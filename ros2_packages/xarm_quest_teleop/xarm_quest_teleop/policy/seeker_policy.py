# xarm_quest_teleop/policy/seeker_policy.py
...
from xarm_quest_teleop.policy.network_base import NetBase
from xarm_quest_teleop.policy.seeker_preprocessing import (
...
def test():
    ckpt_path = "~/ros2_ws/src/experiment/demos-50_agentview-pass_through_eye_in_hand-pass_through_seed-0/checkpoints/latest.ckpt"
