...
from xarm_quest_teleop.io.camera import CamRgbDepthSync, TwoRgbSync
from xarm_quest_teleop.io.process_manager import ManagedProcess, ProcessSupervisor, wait_for_topic, wait_for_service, SampleRing

from xarm_quest_teleop.utils.config_utils import load_dataset_json
...
from xarm_quest_teleop.configs.collector_config import CollectorConfig

from xarm_quest_teleop.robots.xarm import XArmRobot
from xarm_quest_teleop.teleop.quest_xarm_teleop_sync import QuestXArmTeleopSync
from xarm_quest_teleop.data_collection.collector import TeleopDataCollector
...
def main():
    ...
    collector_cfg.launch.stamp_cmd = ["ros2", "run", teleop_cfg.scripts_package, "quest_stamped_node"]
